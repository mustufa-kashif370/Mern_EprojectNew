...
function Host_Form() {
  ...
  const cityExpoMapping = {
    Karachi: "Karachi Expo Center",
    Lahore: "Lahore International Expo Centre",
    Islamabad: "Jinnah Convention Center",
    Multan: "Multan Expo Store",
    Peshawar: "Expo Center Peshawar",
    Quetta: "Expo Center Quetta",
  };
  ...
  const handleCityChange = (e) => {
    ...
    const correspondingExpo = cityExpoMapping[selectedCity] || "";
                ...
                <form className="w-full max-w-lg" onSubmit={handleSubmit}>
                  <div className="flex flex-wrap -mx-3 mb-6">
                    <div className="w-full md:w-1/1 px-3 md:mb-0">
                      <p className="block uppercase tracking-wide text-center text-gray-700 text-md font-bold mb-2">
                    ...
                    <div className="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                      ...
                      >
                        ...
                        {Object.keys(cityStateMapping).map((city) => (
                    ...
                    <div className="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                      ...
                      <input
                        className="appearance-none block w-full border border-gray-300 rounded py-3 px-4 mb-3 leading-tight bg-gray-100 focus:outline-none"
                        id="state"
                        name="state"
                        value={formData.state}
                        readOnly
                        placeholder="State will be selected automatically"
                      />
                    </div>
                    <div className="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                      <label
                    ...
                    <div className="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                      ...
                      >
                        <option value="" disabled className="text-gray-200">
                          Select a expo center
                        </option>
                        {Object.values(cityExpoMapping).map((expo, index) => (
                          <option key={index} value={expo}>
                            {expo}
                          </option>
                        ))}
                      </select>
                  ...
                  <div className="flex flex-wrap  -mx-3 mb-6">
                    <div className="w-full ">
                      <div className="bh_btn">
                        <button
                          type="submit"
                          className=" btn  buttongetstarted"
                          id="send_mess"
                        >
                          Apply Request
                        </button>
                  ...
                  <h1 style={{ color: "darkblue " }}>
                    Disclaimer : <span> Only For Pakistan.</span>
                  </h1>
                </form>
              </div>
            </div>
